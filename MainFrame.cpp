...
{
    SetBackgroundColour(wxColour(*wxLIGHT_GREY)); // Establecer color de fondo azul
    ...
    deleteButton = new wxButton(panel, wxID_ANY, "Delete Contact", wxPoint(300, 380), wxSize(200, 35));
    deleteButton->SetFont(bottons);

    deleteAll = new wxButton(panel, wxID_ANY, "Delete All", wxPoint(300, 480), wxSize(200, 35));
...
void ContactBookFrame::BubbleSort()
{
    ...
    if (temp == nullptr)
    {
       // wxMessageBox("Empty contact Book");
    }
    else
    {
...
void ContactBookFrame::OnDeleteButtonClick(wxCommandEvent& event)
{
    ...
    {
        wxMessageBox("Invalid command. Please try again.");
    }
